...
public class PopWindow extends PopupWindow {
    ...
    public PopWindow(final Activity context){
        ...
        conentView = inflater.inflate(R.layout.pop_mum, null);
        ...
        conentView.findViewById(R.id.pop_baojia).setOnClickListener(new View.OnClickListener() {
        ...
        conentView.findViewById(R.id.pop_dindan).setOnClickListener(new View.OnClickListener() {
