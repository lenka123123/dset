...
import com.wokun.dset.address.bean.CityBean;
import com.wokun.dset.address.bean.DistrictBean;
import com.wokun.dset.address.bean.ProvinceBean;
...
//实现三级联动效果的Activity
public abstract class BaseLevelThreeLinkageActivity extends BaseBindingActivity2 {
        ...
        if (isLoaded) {
            OptionsPickerView pvOptions = new OptionsPickerView.Builder(this, new OptionsPickerView.OnOptionsSelectListener() {
                ...
                public void onOptionsSelect(int options1, int options2, int options3, View v) {
                    ...
                    onAddressSelectedListener.onAddressSelected(address,  var1.getAreaName(), var2.getAreaName(), var3.getAreaName());
    ...
    public interface OnAddressSelectedListener {
        void onAddressSelected(String address, String provinceCode, String cityCode, String districtCode);
    }
